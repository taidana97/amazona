...
const update = ({ userId, name, email, password }) => async (
  ...
  try {
    ...
    dispatch({ type: USER_UPDATE_FAIL, playload: error.message });
  }
};
...
const signin = (email, password) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({ type: USER_SIGNIN_FAIL, playload: error.message });
  }
};
...
const register = (name, email, password) => async (dispatch) => {
  ...
  try {
    ...
    dispatch({ type: USER_REGISTER_FAIL, playload: error.message });
  }
};
